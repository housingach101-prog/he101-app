...
const INIT_USERS = {
  ...
  renter_a: { id: "renter_a", role: "renter", name: "Jordan Davis", password: "Renter123!", agency: "ACH001", email: "jordan@email.com", enrollDate: daysAgo(21), requiresMoveInClearance: true, deadlineExtended: false, caseNote: "", modules: { 1:{status:"complete",score:9,total:10,date:daysAgo(20),time:42}, 2:{status:"complete",score:8,total:10,date:daysAgo(18),time:38}, 3:{status:"complete",score:10,total:10,date:daysAgo(15),time:45}, 4:{status:"complete",score:9,total:10,date:daysAgo(12),time:50}, 5:{status:"complete",score:8,total:10,date:daysAgo(10),time:35}, 6:{status:"complete",score:10,total:10,date:daysAgo(8),time:40}, 7:{status:"complete",score:9,total:10,date:daysAgo(5),time:44}, 8:{status:"complete",score:10,total:10,date:daysAgo(2),time:48} }, outcomes:{stillHoused:true,violations:0,payment:"on_time",checkin:daysAgo(2)}, certIssued:true, certDate:daysAgo(2), certId:"HE101-2026-JD-001" },
